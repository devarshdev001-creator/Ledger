...
import { LogIn, Sparkles, Globe, Moon, Sun } from 'lucide-react';
...
export function LoginScreen({ language, theme, onLogin, onSwitchToSignup, onLanguageChange, onThemeChange }: LoginScreenProps) {
